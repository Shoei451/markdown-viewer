...
<head>
  ...
  <title>地理総合 1学期期末試験過去問 — Shoei451</title>
  ...
  <div class="password-dialog">
    ...
    <form id="password-form">
      ...
      <button type="submit" class="password-submit">
        <span id="submit-text">記事を表示</span>
...
<main class="post-wrapper">
  ...
  <div class="post-header">
    <h1 id="post-title">
      記事タイトル
      <!--<span class="protected-indicator">🔒 Protected</span>-->
    </h1>
    
    <div class="post-meta">
      <span class="post-meta-item">📅 <span id="post-date">2026-01-13</span></span>
      <span class="post-meta-item">⏱️ <span id="read-time">5</span> min read</span>
    </div>
...
// ==========================================
const POST_CONFIG = {
  slug: 'geo-1-final-questions',  // Supabaseのslugと一致させる
  category: 'geography',                 // カテゴリ
...
passwordForm.addEventListener('submit', async (e) => {
  ...
  try {
    ...
    if (result.success) {
      ...
      document.title = `${post.title} — Shoei451`;
    ...
    passwordError.textContent = '⚠️ エラーが発生しました';
    passwordError.classList.add('show');
  } finally {
    // UI復元
